...
add_files -norecurse -scan_for_includes ../../axi4_to_lite/rtl/verilog/axi4_to_lite.v
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi4_to_lite_0/axi_aclk] [get_bd_pins bfm_axi_if_0/m_axi_aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins gpio_axi_lite_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi4_to_lite_0/axi_aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
