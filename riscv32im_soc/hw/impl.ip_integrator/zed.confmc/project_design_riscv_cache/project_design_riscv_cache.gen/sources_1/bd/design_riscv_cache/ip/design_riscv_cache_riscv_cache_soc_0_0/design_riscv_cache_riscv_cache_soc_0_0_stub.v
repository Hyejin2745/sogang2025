...
// Date        : Wed Nov 26 10:36:15 2025
// Host        : sogang-500TGA-500SGA running 64-bit Ubuntu 22.04.5 LTS
// Command     : write_verilog -force -mode synth_stub
//               /home/sogang/Desktop/riscv_platform_1020/riscv32im_soc/hw/impl.ip_integrator/zed.confmc/project_design_riscv_cache/project_design_riscv_cache.gen/sources_1/bd/design_riscv_cache/ip/design_riscv_cache_riscv_cache_soc_0_0/design_riscv_cache_riscv_cache_soc_0_0_stub.v
...
module design_riscv_cache_riscv_cache_soc_0_0(uart_txd, uart_rxd, uart_rts_n, uart_cts_n, 
  gpio_in, gpio_out, sda, scl, sda_a, scl_a, cpu_resetn, axi_aresetn, axi_aclk, s_axi_confmc_awid, 
  s_axi_confmc_awaddr, s_axi_confmc_awlen, s_axi_confmc_awsize, s_axi_confmc_awburst, 
  s_axi_confmc_awvalid, s_axi_confmc_awready, s_axi_confmc_wdata, s_axi_confmc_wstrb, 
  s_axi_confmc_wlast, s_axi_confmc_wvalid, s_axi_confmc_wready, s_axi_confmc_bid, 
  s_axi_confmc_bresp, s_axi_confmc_bvalid, s_axi_confmc_bready, s_axi_confmc_arid, 
  s_axi_confmc_araddr, s_axi_confmc_arlen, s_axi_confmc_arsize, s_axi_confmc_arburst, 
  s_axi_confmc_arvalid, s_axi_confmc_arready, s_axi_confmc_rid, s_axi_confmc_rdata, 
  s_axi_confmc_rresp, s_axi_confmc_rlast, s_axi_confmc_rvalid, s_axi_confmc_rready, 
  m_axi_mem_awid, m_axi_mem_awaddr, m_axi_mem_awlen, m_axi_mem_awsize, m_axi_mem_awburst, 
  m_axi_mem_awvalid, m_axi_mem_awready, m_axi_mem_wdata, m_axi_mem_wstrb, m_axi_mem_wlast, 
  m_axi_mem_wvalid, m_axi_mem_wready, m_axi_mem_bid, m_axi_mem_bresp, m_axi_mem_bvalid, 
  m_axi_mem_bready, m_axi_mem_arid, m_axi_mem_araddr, m_axi_mem_arlen, m_axi_mem_arsize, 
  m_axi_mem_arburst, m_axi_mem_arvalid, m_axi_mem_arready, m_axi_mem_rid, m_axi_mem_rdata, 
  m_axi_mem_rresp, m_axi_mem_rlast, m_axi_mem_rvalid, m_axi_mem_rready)
/* synthesis syn_black_box black_box_pad_pin="uart_txd,uart_rxd,uart_rts_n,uart_cts_n,gpio_in[7:0],gpio_out[7:0],sda,scl,sda_a,scl_a,cpu_resetn,axi_aresetn,axi_aclk,s_axi_confmc_awid[3:0],s_axi_confmc_awaddr[31:0],s_axi_confmc_awlen[7:0],s_axi_confmc_awsize[2:0],s_axi_confmc_awburst[1:0],s_axi_confmc_awvalid,s_axi_confmc_awready,s_axi_confmc_wdata[31:0],s_axi_confmc_wstrb[3:0],s_axi_confmc_wlast,s_axi_confmc_wvalid,s_axi_confmc_wready,s_axi_confmc_bid[3:0],s_axi_confmc_bresp[1:0],s_axi_confmc_bvalid,s_axi_confmc_bready,s_axi_confmc_arid[3:0],s_axi_confmc_araddr[31:0],s_axi_confmc_arlen[7:0],s_axi_confmc_arsize[2:0],s_axi_confmc_arburst[1:0],s_axi_confmc_arvalid,s_axi_confmc_arready,s_axi_confmc_rid[3:0],s_axi_confmc_rdata[31:0],s_axi_confmc_rresp[1:0],s_axi_confmc_rlast,s_axi_confmc_rvalid,s_axi_confmc_rready,m_axi_mem_awid[5:0],m_axi_mem_awaddr[31:0],m_axi_mem_awlen[7:0],m_axi_mem_awsize[2:0],m_axi_mem_awburst[1:0],m_axi_mem_awvalid,m_axi_mem_awready,m_axi_mem_wdata[31:0],m_axi_mem_wstrb[3:0],m_axi_mem_wlast,m_axi_mem_wvalid,m_axi_mem_wready,m_axi_mem_bid[5:0],m_axi_mem_bresp[1:0],m_axi_mem_bvalid,m_axi_mem_bready,m_axi_mem_arid[5:0],m_axi_mem_araddr[31:0],m_axi_mem_arlen[7:0],m_axi_mem_arsize[2:0],m_axi_mem_arburst[1:0],m_axi_mem_arvalid,m_axi_mem_arready,m_axi_mem_rid[5:0],m_axi_mem_rdata[31:0],m_axi_mem_rresp[1:0],m_axi_mem_rlast,m_axi_mem_rvalid,m_axi_mem_rready" */;
  output uart_txd;
  input uart_rxd;
  output uart_rts_n;
  input uart_cts_n;
