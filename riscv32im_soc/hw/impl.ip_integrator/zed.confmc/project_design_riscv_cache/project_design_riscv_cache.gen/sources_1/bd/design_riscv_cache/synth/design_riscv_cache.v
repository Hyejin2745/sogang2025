...
module design_riscv_cache
  ...
  wire [7:0]riscv_cache_soc_0_gpio_in;
  ...
  wire riscv_cache_soc_0_scl;
  wire riscv_cache_soc_0_scl_a;
  wire riscv_cache_soc_0_sda;
  wire riscv_cache_soc_0_sda_a;
  ...
  assign riscv_cache_soc_0_gpio_in = gpio_in[7:0];
  assign scl = riscv_cache_soc_0_scl;
  ...
  design_riscv_cache_riscv_cache_soc_0_0 riscv_cache_soc_0
       (.axi_aclk(clk_wiz_0_clk_out2),
        ...
        .gpio_in(riscv_cache_soc_0_gpio_in),
