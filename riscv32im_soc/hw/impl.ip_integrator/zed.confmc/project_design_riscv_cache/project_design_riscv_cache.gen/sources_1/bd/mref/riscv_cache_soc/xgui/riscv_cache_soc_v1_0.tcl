...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ADDR_I2C_A" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "IRQ_I2C" -parent ${Page_0}
  ipgui::add_param $IPINST -name "IRQ_I2C_A" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "SIZE_I2C_A" -parent ${Page_0}
...
proc update_PARAM_VALUE.ADDR_I2C { PARAM_VALUE.ADDR_I2C } {
	# Procedure called to update ADDR_I2C when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ADDR_I2C { PARAM_VALUE.ADDR_I2C } {
	# Procedure called to validate ADDR_I2C
	return true
}

proc update_PARAM_VALUE.ADDR_I2C_A { PARAM_VALUE.ADDR_I2C_A } {
	# Procedure called to update ADDR_I2C_A when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ADDR_I2C_A { PARAM_VALUE.ADDR_I2C_A } {
	# Procedure called to validate ADDR_I2C_A
	return true
}
...
proc update_PARAM_VALUE.IRQ_I2C { PARAM_VALUE.IRQ_I2C } {
	# Procedure called to update IRQ_I2C when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.IRQ_I2C { PARAM_VALUE.IRQ_I2C } {
	# Procedure called to validate IRQ_I2C
	return true
}

proc update_PARAM_VALUE.IRQ_I2C_A { PARAM_VALUE.IRQ_I2C_A } {
	# Procedure called to update IRQ_I2C_A when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.IRQ_I2C_A { PARAM_VALUE.IRQ_I2C_A } {
	# Procedure called to validate IRQ_I2C_A
	return true
}
...
proc update_PARAM_VALUE.SIZE_I2C { PARAM_VALUE.SIZE_I2C } {
	# Procedure called to update SIZE_I2C when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SIZE_I2C { PARAM_VALUE.SIZE_I2C } {
	# Procedure called to validate SIZE_I2C
	return true
}

proc update_PARAM_VALUE.SIZE_I2C_A { PARAM_VALUE.SIZE_I2C_A } {
	# Procedure called to update SIZE_I2C_A when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SIZE_I2C_A { PARAM_VALUE.SIZE_I2C_A } {
	# Procedure called to validate SIZE_I2C_A
	return true
}
...
proc update_MODELPARAM_VALUE.ADDR_I2C { MODELPARAM_VALUE.ADDR_I2C PARAM_VALUE.ADDR_I2C } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ADDR_I2C}] ${MODELPARAM_VALUE.ADDR_I2C}
}

proc update_MODELPARAM_VALUE.ADDR_I2C_A { MODELPARAM_VALUE.ADDR_I2C_A PARAM_VALUE.ADDR_I2C_A } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ADDR_I2C_A}] ${MODELPARAM_VALUE.ADDR_I2C_A}
}
...
proc update_MODELPARAM_VALUE.SIZE_I2C_A { MODELPARAM_VALUE.SIZE_I2C_A PARAM_VALUE.SIZE_I2C_A } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SIZE_I2C_A}] ${MODELPARAM_VALUE.SIZE_I2C_A}
}
...
proc update_MODELPARAM_VALUE.IRQ_I2C { MODELPARAM_VALUE.IRQ_I2C PARAM_VALUE.IRQ_I2C } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.IRQ_I2C}] ${MODELPARAM_VALUE.IRQ_I2C}
}

proc update_MODELPARAM_VALUE.IRQ_I2C_A { MODELPARAM_VALUE.IRQ_I2C_A PARAM_VALUE.IRQ_I2C_A } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.IRQ_I2C_A}] ${MODELPARAM_VALUE.IRQ_I2C_A}
}
