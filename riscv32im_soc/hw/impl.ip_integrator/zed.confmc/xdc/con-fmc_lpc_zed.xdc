...
set_property SLEW FAST [get_ports {SL_DT[31]}]
set_property SLEW FAST [get_ports {SL_DT[30]}]
set_property SLEW FAST [get_ports {SL_DT[29]}]
set_property SLEW FAST [get_ports {SL_DT[28]}]
set_property SLEW FAST [get_ports {SL_DT[27]}]
set_property SLEW FAST [get_ports {SL_DT[26]}]
set_property SLEW FAST [get_ports {SL_DT[25]}]
set_property SLEW FAST [get_ports {SL_DT[24]}]
set_property SLEW FAST [get_ports {SL_DT[23]}]
set_property SLEW FAST [get_ports {SL_DT[22]}]
set_property SLEW FAST [get_ports {SL_DT[21]}]
set_property SLEW FAST [get_ports {SL_DT[20]}]
set_property SLEW FAST [get_ports {SL_DT[19]}]
set_property SLEW FAST [get_ports {SL_DT[18]}]
set_property SLEW FAST [get_ports {SL_DT[17]}]
set_property SLEW FAST [get_ports {SL_DT[16]}]
set_property SLEW FAST [get_ports {SL_DT[15]}]
set_property SLEW FAST [get_ports {SL_DT[14]}]
set_property SLEW FAST [get_ports {SL_DT[13]}]
set_property SLEW FAST [get_ports {SL_DT[12]}]
set_property SLEW FAST [get_ports {SL_DT[11]}]
set_property SLEW FAST [get_ports {SL_DT[10]}]
set_property SLEW FAST [get_ports {SL_DT[9]}]
set_property SLEW FAST [get_ports {SL_DT[8]}]
set_property SLEW FAST [get_ports {SL_DT[7]}]
set_property SLEW FAST [get_ports {SL_DT[6]}]
set_property SLEW FAST [get_ports {SL_DT[5]}]
set_property SLEW FAST [get_ports {SL_DT[4]}]
set_property SLEW FAST [get_ports {SL_DT[3]}]
set_property SLEW FAST [get_ports {SL_DT[2]}]
set_property SLEW FAST [get_ports {SL_DT[1]}]
set_property SLEW FAST [get_ports {SL_DT[0]}]
set_property SLEW FAST [get_ports SL_CS_N]
set_property SLEW FAST [get_ports SL_OE_N]
set_property SLEW FAST [get_ports SL_PCLK]
set_property SLEW FAST [get_ports SL_PKTEND_N]
set_property SLEW FAST [get_ports SL_RD_N]
set_property SLEW FAST [get_ports SL_WR_N]
